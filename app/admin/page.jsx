...
import GenderDonutChart from "@components/getGenderCounts";
        ...
        <div>
          <div className="grid grid-cols-1 xl:grid-cols-4 min-[864px]:grid-cols-2 gap-4 py-4">
            <div className="card">
              <div>
                Students
                <p className="dash-text">{students.length}</p>
              </div>
              <img
                className="h-full"
            ...
            <div className="card">
              <div>
                Teachers
                <p className="dash-text">{teachers.length}</p>
              </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 h-70 gap-4 mb-5">
